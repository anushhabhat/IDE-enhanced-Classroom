        ...
        return (
            <div className="dashlink">
                <ul>
                    ...
                    {/*<Link to={`/ide/${props.subjectId}`}><li>IDE</li></Link>*/}
                    <Link to={`/assignment/${props.subjectId}`}><li>Assignments</li></Link>
                </ul>
            </div>
        )
    }
    return (
        <div>
            ...
            <div className="dashboard">
                <h3 className="dashlogo">
                    <MenuIcon className="drawerIcon" onClick={()=>{setDrawer(!openDrawer)}} />
                    <Link to="/home">My Classroom</Link>
                </h3>
                <h3> 
                <span title='Profile'><AccountCircleIcon className="rightIcon" style={{ fontSize: "130%" }} onClick={() => { setOpenProfile(!openProfile) }} /></span>
                <span title='Join a Class'><AddIcon  className="rightIcon" style={{ fontSize: "130%" }}  onClick={handleShow}/></span>
                 </h3>
